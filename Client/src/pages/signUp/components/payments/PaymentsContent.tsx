...
export default function PaymentsContent({
  ...
  return (
    <div className="content">
      <p className="text">
        Aby sfinalizować rejestrację, kliknij przycisk Zapłać z PayPal i zaloguj
        się do serwisu PayPal przy użyciu swojego adresu e-mail i hasła.
      </p>
      <p className="content__main-text">
        Kliknięcie przycisku „Zapłać i subskrybuj” oznacza zgodę na
        natychmiastową aktywację subskrypcji, przy czym możesz odstąpić od umowy
        i otrzymać zwrot środków w ciągu pierwszych 14 dni, chyba że
        rozpoczniesz korzystanie z treści cyfrowych w serwisie FilmeX. W
        przypadku subskrypcji miesięcznej będziemy pobierać opłatę miesięczną w
        wysokości 28,99 zł w sposób cykliczny. W przypadku subskrypcji rocznej
        pobierzemy opłatę roczną w wysokości 289,90 zł na początku okresu
        rozliczeniowego, po którego upływie będziemy automatycznie pobierać
        opłatę miesięczną w wysokości 28,99 zł w sposób cykliczny. Subskrypcję
        możesz anulować w dowolnym momencie, ze skutkiem na koniec okresu
        rozliczeniowego. Nie zwracamy środków ani nie udzielamy rekompensaty za
        częściowo wykorzystane miesiące lub lata.
      </p>
      <button
        type="submit"
        className="form-button button-primary button--paypal"
      >
